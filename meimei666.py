...
def allurl():
    ...
    while count1 < count1_max:
        ...
        if(count1 == 1):
            url = 'http://www.meimei666.com/ent/rentiyishu/'
        else:
            url = 'https://www.yaoraotu.com/taotu/index_' + str(count1) + '.html'
        ...
        s = set()
        link_list = pattern.xpath('//div[@class="MeinvTuPianBox"]/ul/li/a/@href')
        # print link_list
        # c = 0
        ...
        for link in s:
            ...
            c =c + 1
            sum1 = 0
            link1 = 'http://www.meimei666.com' + link
            girlurl(link1,headers,sum1)
            #break
        count1 = count1 + 1
        #print url
        #c = c +1
...
def girlurl(url,headers,sum1):
    ...
    while 1:
        ...
        #print response
        pattern = etree.HTML(response)
        dirName = pattern.xpath('//div[@class="articleV2Title"]/h1/text()')
        #print dirName
        for ccc in dirName:
        ...
        path= r'/home/liang/Pictures/meimei666/rentiyisu'
        ...
        link_list = pattern.xpath('//div[@class="articleV2Body"]/p/strong/a/img/@src')
        #print link_list
        #print link1
        #print url
        for link in link_list:
